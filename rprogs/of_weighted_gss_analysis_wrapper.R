...
setwd("~/Network-Shares/Datalab-MA/MAA2016-15 Supporting the Social Investment Unit/outcomes_framework/benefit_transitions/rprogs")
...
make_samples <- function(val1, val2 = val1, wgt1 = NULL, wgt2 = NULL, nn = 3000){
  ...
  samp2 <- sample(val2, nn, replace=TRUE, prob=replace(wgt2,wgt2<0,0))
  # return
